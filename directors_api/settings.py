"""
Django settings for directors_api project.
...
MIDDLEWARE = [
    ...
    # Add whitenoise middleware as the second middleware
...
ROOT_URLCONF = 'directors_api.urls'
...
WSGI_APPLICATION = 'directors_api.wsgi.application'
